# Mapa del deck — Escalamiento de Conpro
...
|---|---|---|---|---|
| 1 | Portada | 1 · Portada | "Escalamiento de Conpro" · "Evaluación de Proyectos · Informe 3" · Grupo 06 · junio 2026 · 6 integrantes | ✅ (nombres ⚠️ pendiente confirmar) |
...
| 6 | Cómo funciona hoy | 9 · Timeline | Flujo WhatsApp: Ricardo informa disponibilidad/mínimo → inscripción → se alcanza mínimo → compra → entrega (despacho o retiro en conserjería) | ✅ |
| 7 | La dependencia de Ricardo | 4 · Bullets | 3 grupos de tareas: **Pedidos** · **Pagos** (transferencias, comprobantes, validación) · **Entrega/coordinación**. Cierre: alta dependencia del fundador | ✅ |
| 8 | Costo de oportunidad | 3 · Stat grid | 4 h/sem ≈ 16 h/mes · ingreso ~$88.000/mes → **~$5.500/h** vs **costo de oportunidad $16.700/h** (acento) | ⚠️ ($16.700 difiere informe/guion) |
...
| 20 | Indicadores: VAN + payback | 6 · Tabla | VAN por escenario: $1.123.525 / **$2.386.311** / $3.969.551 · payback · TIR 45,7/57,9/69,3% · WACC 29,59% | ✅ (payback x escenario ⚠️) |
...
| 25 | Proyecto vs CBO | 13 · Comparación | Inversión **$2.445.000 vs $295.000** · VAN ~$2,4M vs ~$2,4M · payback 3 años vs 1 año · riesgo Alto vs Bajo. **"Recomendado" en CBO** | ✅ |
| 26 | FODA | 18 · Matriz | F: cercanía, comunidad con confianza · O: e-commerce alimentos, contexto pro-ahorro · D: dependencia proveedores, logística, volumen mínimo, sin marca digital · A: presión multicanal, imitación, regulación datos, desintermediación | ✅ |

## Cierre
| # | Título | Molde | Contenido (conciso) | Dato |
|---|---|---|---|---|
| 27 | Recomendaciones | 4 · Bullets | **No ejecutar ya** (VAN+ pero < CBO) · operar CBO y validar demanda · **gatillo de hogares** para invertir | ✅ (cálculo hogares-viable ❓) |
...
- **Gráficos (6) → ids únicos de canvas** (resuelve el choque de ids; `CHART_CONFIGS` pasa a data-driven):
  `chart-precios` (5) · `chart-demanda` (17) · `chart-ganancias` (19) · `chart-tornado` (22) · `chart-margenes` (23) · `chart-esperar` (24).
- **Reuso de moldes:** divisor ×5 · cita ×4 (4,12,15,28) · split ×3 (5,10,22) · timeline ×2 (6,14) · stat grid ×2 (8,18) · barras ×2 (23,24) · bullets ×2 (7,27).
- **Tornado (22)** y **rangos de precio (5)** = variantes del molde de barras (heredan su estilo, no se diseñan aparte).
- **`que-no-hacer.md`:** no truncar ejes (clave en 25 Proyecto vs CBO) · un acento por slide · jerarquía por tamaño.

## TODO de datos (avanzar con placeholders + comentario en la slide)
- S17: `x%` del mercado potencial + dataset de demanda por escenario (5 años).
- S19: tabla de ganancias años 1-5.
- S20: payback por escenario.
- S22: valores del tornado.
- S5: precios exactos (min/Conpro/máx) de los 5 productos.
- S8/S18: unificar cifras que difieren entre guion e informe ($16.700/h, $310.000).
